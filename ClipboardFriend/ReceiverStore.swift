...
class ReceiverStore: ObservableObject {
    ...
    private static func fileURL() throws -> URL { // e.g. file:///Users/paul/Library/Containers/de.pschwind.ClipboardFriend/Data/Library/Application%20Support/receiver.data
    ...
    func save(receiverId: String) async throws {
        ...
        let outfile = try Self.fileURL() // Get filepath e.g. file:///Users/paul/Library/Containers/de.pschwind.ClipboardFriend/Data/Library/Application%20Support/receiver.data
    ...
    func delete() async throws {
        ...
        let fileURL = try Self.fileURL() // Get filepath e.g. file:///Users/paul/Library/Containers/de.pschwind.ClipboardFriend/Data/Library/Application%20Support/receiver.data
