struct User: Codable, Equatable {
    ...
    var lastReceivedClipboardContent: String? // Last clipboard content received from another user. Needed because of the small payload size limit of APNs. e.g. "Hello, world!
}
